  ...
  const benefits = [
    {
      ...
      description: "1 million SPKZ tokens grants perks & entry into the gated Speakeasy on Mostro's Discord."
    },
    {
      icon: "📋",
    ...
    <section className="relative py-24 sm:py-32 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-transparent via-[#000000] to-transparent">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-20 animate-fade-in-up">
          <h2 className="mb-6 text-[#FFFFFF] text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl">1M SPKZ get you a key to</h2>
        ...
        <div className="overflow-hidden">
          ...
          >
            {allBenefits.map((benefit, index) => (
              <div
                key={index}
                className="flex-shrink-0 w-80 group relative bg-gradient-to-br from-[#1E97E6]/10 to-[#9C8BE7]/10 border border-[#3FD9FF]/30 rounded-xl p-8 lg:p-10 hover:border-[#D3FE3D] transition-all duration-300 hover:shadow-[0_0_30px_rgba(211,254,61,0.2)] animate-fade-in-up"
              ...
              <h3 className="mb-4 text-[#FFFFFF] text-lg sm:text-xl md:text-2xl">{benefit.title}</h3>
              <p className="text-[#D2D2D5] text-sm sm:text-base md:text-lg">{benefit.description}</p>
